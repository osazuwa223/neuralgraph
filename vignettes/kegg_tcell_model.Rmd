...
sachs_kegg_map <- data.frame(
  ...
  kegg = c("hsa:5894", "hsa:5604", "hsa:5335", "hsa:5594", "hsa:10000", "hsa:5588", "hsa:1432", "hsa:5601", "hsa:5566"),
  stringsAsFactors = F
) %>%
  `rownames<-`(.$kegg)
sachs_kegg_map
...
g_igraph <- g_igraph + vertices(c("PIP2", "PIP3")) 
...
V(g_igraph)[keepers]$name <- V(g_igraph)[keepers]$label
