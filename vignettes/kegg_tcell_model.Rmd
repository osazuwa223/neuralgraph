...
```{r}
.sub_data <- sample_n(.data, 100)
sub_net <- simplify(sub_net)
g <- initializeGraph(sub_net, data = .sub_data, fixed = ints, graph_attr = list(L2_pen = .04))
fit1 <- fitNetwork(sub_net, .sub_data, fixed = ints, graph_attr = list(L2_pen = .04,
